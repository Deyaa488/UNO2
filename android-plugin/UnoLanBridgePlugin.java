...
public class UnoLanBridgePlugin extends Plugin {
        ...
        try {
            ...
            server = new UnoWebSocketServer(port, new UnoWebSocketServer.MessageListener() {
                ...
                public void onMessageReceived(WebSocket conn, String message) {
                    ...
                    ret.put("clientId", conn.hashCode());
                ...
                public void onClientConnected(WebSocket conn) {
                    JSObject ret = new JSObject();
                    ret.put("clientId", conn.hashCode());
                    ret.put("remoteAddress", conn.getRemoteSocketAddress() != null ? conn.getRemoteSocketAddress().toString() : "");
    ...
    public void broadcastMessage(PluginCall call) {
        ...
        if (server != null && msg != null) {
            ...
            call.reject("Server not running or empty message");
        }
    }
    ...
    public void sendToClient(PluginCall call) {
        ...
        String msg = call.getString("message");
        if (server != null && clientId != null && msg != null) {
            server.sendToClient(clientId, msg);
            call.resolve();
        } else {
            call.reject("Server not running or invalid parameters");
        }
    }
        ...
        try {
            ...
            discoveryListener = new NsdManager.DiscoveryListener() {
                ...
                public void onServiceFound(NsdServiceInfo serviceInfo) {
                    if (serviceInfo != null && serviceInfo.getServiceType() != null && serviceInfo.getServiceType().contains("_uno3d")) {
        ...
        nsdManager.resolveService(serviceInfo, new NsdManager.ResolveListener() {
            ...
            public void onServiceResolved(NsdServiceInfo resolvedService) {
                if (resolvedService != null) {
                    ...
                    String serviceName = resolvedService.getServiceName();

                    String roomCode = "";
                    if (serviceName != null && serviceName.startsWith("UNO3D_")) {
                        roomCode = serviceName.substring(6);
                    }
